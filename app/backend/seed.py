    ...
    projects = [
        {
            ...
            "assigned_lead_email": "adebayo@dataguard.ng",
            "requires_page_count": False,
            "requires_indexing_count": True,
            "target_velocity": 200,
        ...
        {
            "id": "p3",
            "name": "Stanbic Ilupeju (Phase 5 - IBC)",
            "client_name": "Stanbic IBTC",
            "activity_type": "Scanned and Verified",
            "container_unit": "Boxes",
            "assigned_lead_email": "adebayo@dataguard.ng",
            "requires_page_count": True,
            "requires_indexing_count": True,
            "target_velocity": 250,
            "daily_baseline_boxes": 250,
            "daily_baseline_files": 1800,
            "daily_baseline_pages": 6000,
            "daily_baseline_indexing": 5000,
            "total_target": 15000,
            "weekly_target": 1250,
            "status": "Active",
            "health": "Green",
            "completion_percent": 60.0,
            "sla_target_date": "2026-11-15",
        },
        {
            "id": "p4",
            "name": "Maersk May 2026",
            "client_name": "Maersk Line",
            "activity_type": "Physical Archiving",
            "container_unit": "Boxes",
            "assigned_lead_email": "emeka@dataguard.ng",
            "requires_page_count": False,
            "requires_indexing_count": False,
            "target_velocity": 150,
            "daily_baseline_boxes": 150,
            "daily_baseline_files": 900,
            "daily_baseline_pages": 0,
        ...
        },
        {
            "id": "p6",
            "name": "Tangerine",
            "client_name": "Tangerine Financial",
            "activity_type": "Scanning & Indexing",
            "container_unit": "Boxes",
            "assigned_lead_email": "chidinma@dataguard.ng",
            "requires_page_count": True,
            "requires_indexing_count": True,
            "target_velocity": 200,
            "daily_baseline_boxes": 200,
            "daily_baseline_files": 1400,
            "daily_baseline_pages": 4500,
            "daily_baseline_indexing": 4000,
            "total_target": 11000,
            "weekly_target": 1000,
            "status": "Active",
        ...
        },
        {
            ...
            "sla_target_date": "2026-10-18",
        },
        {
            "id": "p8",
            "name": "Headquarters OPIC (General)",
            "client_name": "DataGuard HQ",
            "activity_type": "Quality Control (QC)",
            "container_unit": "Boxes",
            "assigned_lead_email": "adebayo@dataguard.ng",
            "requires_page_count": True,
            "requires_indexing_count": False,
            "target_velocity": 400,
            "daily_baseline_boxes": 400,
            "daily_baseline_files": 2500,
            "daily_baseline_pages": 10000,
            "daily_baseline_indexing": 0,
            "total_target": 20000,
            "weekly_target": 2000,
            "status": "Active",
